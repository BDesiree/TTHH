...
<html>
    ...
    <body>
        ...
        <div class="container container-form">
            ...
            <form action="ServletCapa" method="POST">
                <div class="form first">   <!-- Inicia la sección del formulario -->
                    <div class="details personal">     <!-- Sección de detalles personales del empleado -->
                        <div class="title"><h3>Datos Capacitación</h3>   </div>  <!-- Título del formulario -->
                        <br>  <div class="fields">    <!-- Inicia la sección de campos  -->
                            ...
                            <div class="input-field">
                                <label for="examIden">Tema del evento</label>
                                <input type="text" name="capaTema"  required  >   <!-- asegura de que el usuario complete el campo  -->
                            </div>
                            <div class="input-field"> 
                                <label for="exampl">Tipo charla</label>
                                <select  name="capaTipoCharla" required > <!--  Inicia un elemento de lista desplegable.  -->
                            ...
                            <div class="input-field">
                                <label for="exampl">Auspiciante</label>
                                <input type="text" name="capaAuspiciante"  required>
                            </div>

                            <div class="input-field">
                                <label for="exampl">Duración</label>
                                <input type="number" name="capaDuracion"  required>
                            </div>
                            <div class="input-field">
                                <label for="exampl">Tipo Certificado</label>
                                <input type="text" name="capatTipoCertificado" required>
                            </div>
                            <div class="input-field">
                                <label for="exampl">Certificado Por</label>
                                <input type="text" name="capaCertificadoPor" required>
                            </div>
                            <div class="input-field">
                                <label for="exampl">Fecha Inicio</label>
                                <input type="date" name="capaFechaInicio" required>
                            </div>
                            <div class="input-field">
                                <label for="exampl">Fecha Fin</label>
                                <input type="date" name="capaFechaFin" required>
                            </div>
                            <div class="input-field">
                                <label for="exampl">Pais</label>
                                <input type="text"name="capaPais" required>
                            </div>
                        </div>
                    </div>
                    <div class="row align-items-center">
                        ...
                        <div class="col mr-2">
                            ...
                            <button id="btnGuardar" name="guardarCapa" type="submit" class="nextBtn pull-right" value="GuardarCapa">
                                <span class="btnText">Guardar</span>
                            </button>
                        </div>
                    </div>
                    <%
                        if (request.getAttribute("caja8") != null) {
                            out.println(request.getAttribute("caja8"));
                    %>
