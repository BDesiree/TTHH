...
<html>
    ...
    <body>
        ...
        <div class="container container-form">
            ...
            <form action="ServletConyu" method="POST">
                <div class="details personal">     <!-- Sección de detalles personales del empleado -->
                    <div class="title"><h3>Datos Conyuge</h3>   </div>  <!-- Título del formulario -->
                    <br>  <div class="fields">  
                        ...
                        <div class="input-field">
                            ...
                            <input type="number" name="conyuIdentidicacion"  required  >   <!-- asegura de que el usuario complete el campo  -->
                        </div>
                        <div class="input-field">
                            <label for="exampl"> Nombres</label>
                            <input type="text" name="conyuNombres"  required>
                        </div>

                        <div class="input-field">
                            <label for="exampl">Apellidos</label>
                            <input type="text" name="conyuApellidos"  required>
                        </div>
                        <div class="input-field">
                            <label for="exampl">Tipo Relación</label>
                            <input type="text" name="conyuTipoRelacion" required>
                        </div>
                    </div>
                </div>
                <div class="row align-items-center">
                    ...
                    <div class="col mr-2">
                        ...
                        <button id="btnGuardar" name="guardarConyu" type="submit" class="nextBtn pull-right" value="GuardarConyu">
                            <span class="btnText">Guardar</span>
                        </button>

                    </div>
                    <%
                        if (request.getAttribute("caja4") != null) {
                            out.println(request.getAttribute("caja4"));
                    %>
