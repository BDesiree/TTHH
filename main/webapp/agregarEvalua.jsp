...
<html>
    ...
    <body>
        ...
        <div class="container container-form">
            ...
            <form action="ServletEva" method="POST">
                <div class="form first">   <!-- Inicia la sección del formulario -->
                    <div class="details personal">     <!-- Sección de detalles personales del empleado -->
                        <div class="title"><h3>Datos  Evaluacion Desemepeño</h3>   </div>  <!-- Título del formulario -->
                        <br>  <div class="fields">    <!-- Inicia la sección de campos  -->
                            ...
                            <div class="input-field">
                                ...
                                <input type="text" name="evaNommbreInstitucion"  required  >   <!-- asegura de que el usuario complete el campo  -->
                            </div>
                            <div class="input-field">
                                <label for="exampl">Período desde</label>
                                <input type="date" name="evaPeriodoDesde" required>
                            </div>
                            <div class="input-field">
                                <label for="exampl">Período hasta</label>
                                <input type="date" name="evaPeriodoHasta" required>
                            </div>

                            <div class="input-field">
                                <label for="puntaje">Puntaje</label>
                                <input type="number" id="puntaje" name="evaPuntaje" required>
                            </div>
                            <div class="input-field"> 
                                <label for="calificacion">Calificación</label>
                                <input type="text" id="calificacion" name="evaCalificacion" required>
                            </div>
                            <div class="input-field">
                                <label for="exampl">Observación</label>
                                <input type="text" name="evaObservacion"  required>
                            </div>
                        </div>
                    </div>
                    <div class="row align-items-center">
                        ...
                        <div class="col mr-2">
                            <!-- Contenido a la izquierda -->
                            <button id="btnGuardar" name="guardarEva" type="submit" class="nextBtn pull-right" value="GuardarEva">
                    ...
                    <%
                        if (request.getAttribute("caja10") != null) {
                            out.println(request.getAttribute("caja10"));
                    %>
