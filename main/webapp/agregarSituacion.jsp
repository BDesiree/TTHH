...
<html>
    ...
    <body>
        ...
        <div class="container container-form">
            ...
            <form action="ServletSit" method="POST">
                <div class="form first">   <!-- Inicia la sección del formulario -->
                    <div class="details personal">     <!-- Sección de detalles personales del empleado -->
                        <div class="title"><h3>Datos Situación Senescyt</h3>   </div>  <!-- Título del formulario -->
                        <br>  <div class="fields">    <!-- Inicia la sección de campos  -->
                            ...
                            <div class="input-field">
                                <label for="exampl">Puesto</label>
                                <input type="text" name="sitPuesto"  required>
                            </div>
                            <div class="input-field">
                                <label for="examIden">Unidad</label>
                                <input type="text" name="sitUnidad"  required  >   <!-- asegura de que el usuario complete el campo  -->
                            </div>
                            <div class="input-field">
                                <label for="exampl">Fecha Ingreso</label>
                                <input type="date" name="sitFechaIngreso" required>
                            </div>
                            <div class="input-field">
                                <label for="exampl">Fecha Salida</label>
                                <input type="date" name="sitFechaSalida" required>
                            </div>
                            <div class="input-field"> 
                                <label for="exampl">Modalidad</label>
                                <select id="tieneHijos" name="sitModalidad" required onchange="handleEstadoChange()">  <!--  Inicia un elemento de lista desplegable.  -->
                            ...
                            <div class="input-field">
                                <label for="exampl">Grupo Ocupacional</label>
                                <input type="text" name="sitGrupoOcupacional"  required>
                            </div>
                        </div>
                    </div>
                    <div class="row align-items-center">
                        ...
                        <div class="col mr-2">
                            <!-- Contenido a la izquierda -->
                            <button id="btnGuardar" name="guardarSitu" type="submit" class="nextBtn pull-right" value="GuardarSitu">
                    ...
                    <%
                        if (request.getAttribute("caja11") != null) {
                            out.println(request.getAttribute("caja11"));
                    %>
